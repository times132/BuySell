                    ...
                    <div class="tab-pane active" id="home">
                        <hr>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <br>
                                    <input class="btn btn-lg btn-success" type="button" value="회원정보수정" onClick="self.location='/user/modifyuser';">
                        ...
                        <form class="form" action="##" method="post" id="registrationForm">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <button class="btn btn-lg" type="HOME"><i class="glyphicon glyphicon-repeat"></i> Reset</button>
                                </div>
                            </div>
                        </form>
